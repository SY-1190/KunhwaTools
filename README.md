...
- 사용자가 제시한 레퍼런스 방향(`tools.mytory.net`)을 바탕으로
  한 화면 내 다중 유틸리티 작업 흐름에 맞춰 구성했습니다.
- 현재는 MVP 성격의 1차 초안이며, 다음 라운드에서 UI/UX 고도화,
  페이지 미리보기 기반 PDF 재정렬 UX, 예외 케이스 처리를 확장하면 좋습니다.
